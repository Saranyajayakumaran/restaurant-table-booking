...
|----------|-----------|---------------|
|Handling login and authentication|Login was trigerred each time user click book a table button even the user is already logged in|Add authentication logic in login html form|
